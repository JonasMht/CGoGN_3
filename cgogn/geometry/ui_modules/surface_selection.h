...
public:
	SurfaceSelection(const App& app, DockingPreference preference = DockingPreference::None)
		: ViewModule(app, "SurfaceSelection (" + std::string{mesh_traits<MESH>::name} + ")", "Geometry", preference),
