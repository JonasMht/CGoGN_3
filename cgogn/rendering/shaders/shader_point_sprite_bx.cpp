...
ShaderPointSpriteBX* ShaderPointSpriteBX::instance_ = nullptr;
...
ShaderPointSpriteColorBX::ShaderPointSpriteColorBX()
{
	const char* vertex_shader_source = R"(
		#version 150
		in vec3 vertex_position;
...
void ShaderParamPointSpriteColorBX::set_uniforms()
{
	shader_->set_uniforms_values(ambiant_color_, light_position_, point_size_, plane_clip_, plane_clip2_);
}

ShaderPointSpriteSizeBX* ShaderPointSpriteSizeBX::instance_ = nullptr;

ShaderPointSpriteSizeBX::ShaderPointSpriteSizeBX()
{
	const char* vertex_shader_source = R"(
		#version 150
		in vec3 vertex_position;
...
void ShaderParamPointSpriteSizeBX::set_uniforms()
{
	shader_->set_uniforms_values(color_, ambiant_color_, light_position_, plane_clip_, plane_clip2_);
}

ShaderPointSpriteColorSizeBX* ShaderPointSpriteColorSizeBX::instance_ = nullptr;

ShaderPointSpriteColorSizeBX::ShaderPointSpriteColorSizeBX()
{
	const char* vertex_shader_source = R"(
		#version 150
		in vec3 vertex_position;
...
void ShaderParamPointSpriteColorSizeBX::set_uniforms()
{
