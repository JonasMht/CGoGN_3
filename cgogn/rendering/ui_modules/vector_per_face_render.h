...
public:
	VectorPerFaceRender(const App& app, DockingPreference preference = DockingPreference::None)
		: ViewModule(app, "VectorPerFaceRender (" + std::string{mesh_traits<MESH>::name} + ")", "Rendering", preference),
